...
class PaymentGate:
    ...
    # â”€â”€ Primary entry point â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
    ...
    async def gate(
        ...
        try:
            ...
            return ErrorResult(
                error=InvalidPaymentError("An unexpected error occurred during payment processing.")
            )

    # â”€â”€ Internal implementation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
    ...
    async def _gate(
        ...
        # â”€â”€ Phase 1: No payment proof â†’ issue challenge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
        ...
        # â”€â”€ Phase 2: Parse and validate the payment signature â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
        ...
        # â”€â”€ Phase 3: Verify + settle under per-key lock â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
        async with self._inflight_lock(key):
            ...
            if not verify_result.ok:
                await self._emit(
                    PaymentEvent.VERIFY_FAILURE,
                    context,
                    config,
                    error_type="InvalidPaymentError",
                    duration_ms=verify_ms,
                )
                raise InvalidPaymentError(f"Payment verification failed: {verify_result.reason}")
            await self._emit(
                PaymentEvent.VERIFY_SUCCESS,
                context,
                config,
                duration_ms=verify_ms,
            )
            ...
            receipt = PaymentReceipt(
                ...
                facilitator_url=(
                    getattr(getattr(self._provider, "_config", None), "facilitator_url", "")
        ...
        # â”€â”€ Phase 4: Non-blocking receipt publication â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
    ...
    # â”€â”€ Helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  # noqa: E501
