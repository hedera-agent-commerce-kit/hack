...
class TestExceptionLeakage:
    ...
    def test_invalid_payment_error_safe(self):
        self._assert_safe_response(InvalidPaymentError("internal detail: sig mismatch at byte 42"))

    def test_facilitator_error_safe(self):
        self._assert_safe_response(FacilitatorError("connection refused to 10.0.0.1:4020"))
    ...
    def test_malformed_error_safe(self):
        self._assert_safe_response(MalformedPaymentError("JSON parse error at position 42"))
