...
@pytest.fixture
def mock_provider(mock_facilitator_client: AsyncMock, valid_requirements: PaymentRequirements) -> AsyncMock:
    ...
    provider.settle = AsyncMock(return_value=SettleResult.success(
        transaction_id=FAKE_TX_ID, payer="0.0.99999"
    ))
...
@pytest.fixture
def payment_gate(mock_provider: AsyncMock, idempotency_store: InMemoryIdempotencyStore) -> PaymentGate:
    return PaymentGate(
