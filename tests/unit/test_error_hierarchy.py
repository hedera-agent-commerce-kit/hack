...
from hack_pay.errors import (
    AssetMismatchError, ConfigurationError, DurableReceiptUnavailableError,
    FacilitatorError, FacilitatorInvalidResponseError, FacilitatorNetworkNotSupportedError,
    FacilitatorTimeoutError, FacilitatorUnavailableError, HackPayError,
    InsufficientPaymentError, InvalidPaymentError, MalformedPaymentError,
    NetworkMismatchError, OversizedPaymentHeaderError, PaymentError,
    ReceiptError, RecipientMismatchError, UnsupportedProtocolVersionError,
)
...
class TestHierarchy:
    def test_all_payment_errors_are_hack_pay_errors(self):
        for cls in [
            MalformedPaymentError, UnsupportedProtocolVersionError,
            InvalidPaymentError, InsufficientPaymentError,
            RecipientMismatchError, AssetMismatchError,
            NetworkMismatchError, OversizedPaymentHeaderError,
        ]:
    ...
    def test_all_facilitator_errors_are_hack_pay_errors(self):
        for cls in [
            ...
            FacilitatorNetworkNotSupportedError, FacilitatorInvalidResponseError,
        ]:
...
class TestErrorCodes:
    def test_each_error_has_unique_code(self):
        errors = [
            HackPayError, ConfigurationError, PaymentError,
            MalformedPaymentError, UnsupportedProtocolVersionError,
            InvalidPaymentError, InsufficientPaymentError,
            RecipientMismatchError, AssetMismatchError, NetworkMismatchError,
            OversizedPaymentHeaderError, FacilitatorError,
            FacilitatorUnavailableError, FacilitatorTimeoutError,
            FacilitatorNetworkNotSupportedError, FacilitatorInvalidResponseError,
            ReceiptError, DurableReceiptUnavailableError,
        ]
